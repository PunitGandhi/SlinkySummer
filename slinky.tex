...
\NOTE{Make minor revisions (Calvin)}
...
this information that the top of the slinky had been dropped was being carried in a (longitudinal) wave to the bottom
...
the slinky as a continuous object rather than a set of connected parts.\TODO{Move this paragraph to discussion}
...
of a torsional wave propagating down the slinky. The torsional wave propagates much
faster than the longitudinal, explaining the observation that the bottom begins
...
\NOTE{Possible sentenc: Just as we gained insight from looking at different models, we also benefited from
