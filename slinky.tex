...
Students then apply familiar concepts in deciding how to model each part. The equations of motion that result from this simple model are quite difficult to solve analytically for slinkys composed of more than a few masses, but the model is still very useful in understanding the slinky drop, in particular, and model building, in general. 
