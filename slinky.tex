...
The slinky drop\NOTEMARG{\calvin{}{Shall we define ``falling slinky,'' ``slinky drop,'' or something similar as a technical term at this point for easier reference later?}} experiment and other related phenomena have
...
<<<<<<< HEAD
only introductory-level Newtonian mechanics.  While the physics of this model 
...
\TODO{Add info about how it is possible to tune parameters with this model}
=======
only an introductory level of Newtonian mechanics.  While the physics of this model 
is readily approachable, the math required to analyze the model quickly spirals out of 
the regime of a pencil-and-paper calculation as the number of discrete masses used to model 
the slinky increases.  \TODO{\calvin{}{Repetitive from above.}}

>>>>>>> 22e29bc6c4efd4f4f391e530bcf32708d35376d7
...
approaches have in handling perturbations.\NOTEMARG{\calvin{}{This paragraph could be removed.
...
By this point, students likely have brough up the wave propertaies of the slinky. One way of moving forward
