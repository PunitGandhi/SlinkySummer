...
(Describe slinky drop and lack of motion at the bottom briefly.) The slinky drop experiment has been studied in detail, \cite{.}.
...
than the the origial slinky, but we would like to make sure that the simplified model also
