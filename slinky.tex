...
\begin{figure}[t]\center
\includegraphics[width=\columnwidth]{figs/FIGpulsedrop}
...
slinky that is hung vertically and released from rest, colloquially known as a ``slinky drop" as shown in \fig{fig:pulsedrop}.
