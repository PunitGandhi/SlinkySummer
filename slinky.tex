...
\begin{abstract}
We describe a curriculum based around the dynamics of a slinky hung vertically in equilibrium that is released from rest.
The motion, or lack thereof, of the bottom of the slinky after the top is released serves as a counterintuitive phenomenon that provides context for learning about scientific model building.
